# Generated by Django 2.2.4 on 2019-09-06 17:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.FileField(help_text='The layout should be primarily in x-y plane.', upload_to=analyses.models.analysis_directory_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('typ', models.CharField(choices=[('Fill everywhere', 'Fill everywhere'), ('Fill the outlet', 'Fill the outlet')], default=0, max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=30)),
                ('typ', models.CharField(choices=[('Inlet', 'Inlet'), ('Outlet', 'Outlet'), ('Wall', 'Wall')], default=0, max_length=30)),
