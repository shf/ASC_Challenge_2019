    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=30)),
                ('typ', models.CharField(choices=[(0, 'Inlet'), (1, 'Outlet'), (2, 'Wall')], default=0, max_length=30)),
                ('condition', models.CharField(choices=[(0, 'Pressure'), (1, 'Flow rate'), (2, 'None')], default=0, max_length=30)),
